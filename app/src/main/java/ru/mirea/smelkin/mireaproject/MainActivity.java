...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_musicPlayer, R.id.nav_gyroFragment, R.id.nav_cameraFragment, R.id.nav_audioFragment, R.id.nav_profileFragment, R.id.nav_filesFragment)
